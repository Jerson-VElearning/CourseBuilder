...
## ON_ENTER completes immediately; ON_CONTINUE on Next; ALL_REVEALS, MEDIA_FINISHED, and QUIZ wait for mark_complete().
...
## ALL_REVEALS, MEDIA_FINISHED, and QUIZ block until mark_complete().
