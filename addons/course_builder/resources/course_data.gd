...
## See: runtime/course_runtime.gd, resources/slide_data.gd, resources/section_data.gd, resources/quiz_data.gd, resources/lms_settings.gd
...
## LMS preset, identifier, and resume. Presets rewrite completion_by and quiz report flags.
@export var lms: IDLmsSettings
...
## Creates a default LMS resource when an older course.tres has none.
func ensure_lms() -> IDLmsSettings:
	if lms == null:
		lms = IDLmsSettings.new()
		emit_changed()
	return lms
